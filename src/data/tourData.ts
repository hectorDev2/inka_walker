...
export const tourData: Tour[] = [
  // Cusco Tours
  {
    ...
    group: 'Mín. 10 pax',
    region: 'Cusco',
    image: 'https://images.pexels.com/photos/259967/pexels-photo-259967.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
    heroImage: 'https://images.pexels.com/photos/259967/pexels-photo-259967.jpeg?auto=compress&cs=tinysrgb&w=1920&h=600&fit=crop',
    highlights: ['Tren panorámico', 'Guía bilingüe', 'Transporte incluido', 'Descuento 10% grupos'],
    description: 'Viaje express desde Cusco a Machu Picchu con tren panorámico y guía experto.',
    fullDescription: 'Descubre la majestuosa ciudadela de Machu Picchu en un día completo lleno de historia y aventura. Este tour express te llevará desde Cusco hasta la Ciudad Perdida de los Incas a través de un viaje en tren panorámico que te permitirá disfrutar de los impresionantes paisajes del Valle Sagrado. Con nuestro guía experto bilingüe, explorarás los misterios y secretos de esta maravilla del mundo mientras aprendes sobre la fascinante cultura inca.',
    itinerary: [
      {
  ...
  },
  {
    ...
    heroImage: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=1920&h=600&fit=crop',
    highlights: ['Valle Sagrado', 'Hotel 3*', 'Comidas incluidas', 'Aguas termales +$20'],
    description: 'Incluye Valle Sagrado + noche en Aguas Calientes para explorar más.',
    fullDescription: 'Vive una experiencia completa de 2 días explorando tanto el Valle Sagrado como Machu Picchu. Este tour extendido te permite disfrutar con calma de los principales atractivos incas, incluyendo una noche de descanso en Aguas Calientes para estar más cerca de la ciudadela. Perfecto para grupos que desean una experiencia más relajada y completa.',
    itinerary: [
      {
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
    heroImage: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=1920&h=600&fit=crop',
    highlights: ['Pisac, Ollantaytambo', 'Almuerzo VIP', 'Transporte premium', 'Kit estudiantil'],
    description: 'Tour premium por el Valle Sagrado con actividades interactivas.',
    fullDescription: 'Experimenta el Valle Sagrado como nunca antes con nuestro tour VIP diseñado especialmente para grupos estudiantiles. Este tour premium incluye visitas a los sitios arqueológicos más importantes, actividades interactivas de aprendizaje, y un almuerzo buffet de primera calidad. Perfecto para grupos que buscan una experiencia educativa y cultural completa.',
    itinerary: [
      {
  ...
  // Sur Tours
  {
    ...
    image: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
    heroImage: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=1920&h=600&fit=crop',
    highlights: ['Volcanes', 'Conventos', 'Cañón del Colca opcional', 'Gastronomía'],
    description: 'Vuelos desde Cusco, tours guiados por la ciudad blanca.',
    fullDescription: 'Descubre la majestuosa Arequipa, conocida como la Ciudad Blanca por su arquitectura colonial construida en sillar volcánico. Este tour de 3 días te llevará por los principales atractivos de la ciudad, incluyendo el famoso Monasterio de Santa Catalina, la Plaza de Armas y los miradores con vistas a los volcanes Misti, Chachani y Pichu Pichu.',
    itinerary: [
      {
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
    heroImage: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=1920&h=600&fit=crop',
    highlights: ['Islas Uros', 'Taquile', 'Danzas folklóricas', 'Almuerzos incluidos'],
    description: 'Islas flotantes y folklore con traslados y bote incluidos.',
    fullDescription: 'Explora el místico Lago Titicaca, el lago navegable más alto del mundo. Visita las famosas islas flotantes de los Uros, construidas completamente de totora, y la isla de Taquile, donde conocerás las tradiciones textiles ancestrales y disfrutarás de espectáculos de danzas folklóricas.',
    itinerary: [
      {
  ...
  },
  {
    ...
    fullDescription: 'Combina cultura, historia y relajación en este tour que te lleva desde los viñedos de Moquegua hasta las hermosas playas de Ilo. Conoce la tradición vitivinícola de la región, explora sitios históricos y disfruta del mar peruano en un ambiente relajado perfecto para grupos.',
    itinerary: [
      {
  ...
  // Costa Tours
  {
    ...
    image: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop',
    heroImage: 'https://images.pexels.com/photos/2356045/pexels-photo-2356045.jpeg?auto=compress&cs=tinysrgb&w=1920&h=600&fit=crop',
    highlights: ['Leones marinos', 'Pingüinos', 'Bote tour', 'Reserva nacional'],
    description: 'Bote tour y reserva nacional desde Ica.',
    fullDescription: 'Descubre la increíble biodiversidad marina del Perú en las Islas Ballestas, conocidas como las "Galápagos peruanas". Observa de cerca leones marinos, pingüinos de Humboldt, pelícanos y una gran variedad de aves marinas en su hábitat natural. Incluye visita a la Reserva Nacional de Paracas.',
    itinerary: [
      {
  ...
  },
  {
    ...
    fullDescription: 'Vive una experiencia llena de adrenalina en el único oasis natural de América del Sur. Disfruta de emocionantes paseos en buggy por las dunas de arena y aprende sandboard con instructores expertos. Perfecto para grupos jóvenes que buscan aventura y diversión en el desierto de Ica.',
    itinerary: [
      {
  ...
  },
  {
    ...
    fullDescription: 'Conoce la cuna del pisco peruano en un tour cultural por las bodegas tradicionales de Ica. Aprende sobre el proceso de elaboración del pisco y vinos, visita museos históricos y disfruta de degustaciones guiadas. Incluye recorrido por el centro histórico de Ica.',
    itinerary: [
      {
